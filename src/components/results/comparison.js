...
//FIND EXPECTED WINNER OF SERIES BASED ON EACH GAME MODE
  ...
  if(hpWinner === sndWinner && hpWinner === conWinner){
    resultsText = 'are most likely to win the series because:</br></br>they have a higher win percentage in ALL 3 game modes';
    winner = hpWinner;
     //finalScore should be 3-0 so it does not need adjusted
  }

  else if(hpWinner === sndWinner){
      resultsText = 'are most likely to win the series because:</br></br>they have a higher win percentage in Hardpoint and Search and Destroy';
      winner = hpWinner;
    ...
    resultsText = 'are most likely to win the series because:</br></br>they have a higher win percentage in Hardpoint and Control';
    winner = hpWinner;
    ...
    resultsText = 'are most likely to win the series because:</br></br>they have a higher win percentage in Search and Destroy and Control';
    winner = sndWinner;
